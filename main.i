...
void update() {
 ...
 if (collision(pCol, pRow, pWidth, pHeight, c1Col, c1Row, cWidth, cHeight) > 0) {
  pColor = c1Color;
 }
 if (collision(pCol, pRow, pWidth, pHeight, c2Col, c2Row, cWidth, cHeight) > 0) {
  pColor = c2Color;
 }
 if (collision(pCol, pRow, pWidth, pHeight, c3Col, c3Row, cWidth, cHeight) > 0) {
  pColor = c3Color;
 }
 if (collision(pCol, pRow, pWidth, pHeight, c4Col, c4Row, cWidth, cHeight) > 0) {
  pColor = c4Color;
 }
...
void draw() {
 ...
 if ((~(*(volatile unsigned short *)0x04000130) & ((1<<2)))) {
  drawRect(pOldCol, pOldRow, pWidth, pHeight, ((31) | (31)<<5 | (31)<<10));
 }
